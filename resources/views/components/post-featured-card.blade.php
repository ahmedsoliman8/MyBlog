...
<article
    ...
    <div class="py-6 px-5 lg:flex">
        <div class="flex-1 lg:mr-8">
            <img src="{{ isset($post->thumbnail) && !empty($post->thumbnail)? asset('thumbnails/' . $post->thumbnail):'/images/illustration-1.png' }}" alt="Blog Post illustration" class="rounded-xl">
        </div>
